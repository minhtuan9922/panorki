...
class ControllerOrderOrder extends Controller {
	...
	public function index() {
		...
		$this->document->setTitle('Danh sách đặt hàng');
	...
	protected function getList() {
		...
		$total = $this->model_order_order->get_total_order($filter_data);

		$results = $this->model_order_order->get_list_order($filter_data);
		...
		$data['sort_name'] = $this->url->link('order/order', 'user_token=' . $this->session->data['user_token'] . '&sort=name' . $url, true);
		$data['sort_address'] = $this->url->link('order/order', 'user_token=' . $this->session->data['user_token'] . '&sort=address' . $url, true);
		$data['sort_telephone'] = $this->url->link('order/order', 'user_token=' . $this->session->data['user_token'] . '&sort=telephone' . $url, true);
		$data['sort_date_added'] = $this->url->link('order/order', 'user_token=' . $this->session->data['user_token'] . '&sort=date_added' . $url, true);
